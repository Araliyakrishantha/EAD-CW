...
public class CEmployeeUpdate {
    public <A,B,C> void cupdateEmployee(A empno, A name, A address, B tel, A gender, C basic, A depno, A title, C etf, C epf, C net_sal){ //parameter passing using generics
