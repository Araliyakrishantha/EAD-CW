...
public class CEmployeeInsert {
    public <A,B,C> void cregisterEmployee(A empno,A name,A address,B tel,A gender,C basic_sal,A depno,A title, C etf, C epf,C net_sal){ //parameter passing using generics
